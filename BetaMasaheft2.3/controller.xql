...
if ($exist:path eq '') then
    ...
    return
            ...
            <set-header name="Cache-Control" value="no-cache"/>
                ...
                ends-with($exist:path, '/home')) then
...
(:                                        if it is an image link inside the app:)
                                        else
                                            if (matches($exist:resource, "\w+\d+.jpeg")) then
                                                <dispatch
                                                    xmlns="http://exist.sourceforge.net/NS/exist">
                                                    <forward
                                                        ...
                                                        if (starts-with($exist:path, "/search.html")) then
                                                            <dispatch
                                                                xmlns="http://exist.sourceforge.net/NS/exist">
                                                                <forward
                                                            ...
                                                            if (starts-with($exist:path, "/transcription.html")) then
                                                                <dispatch
                                                                    xmlns="http://exist.sourceforge.net/NS/exist">
                                                                    <forward
                                                                        url="{$exist:controller}/transcription/transcription.html"
                                                                        method="get">
