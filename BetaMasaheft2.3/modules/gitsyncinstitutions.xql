                        ...
                        <message>
                            {
                                ...
                                sm:chgrp(xs:anyURI(concat($collection, '/', $file-name)), 'Cataloguers')
                                )
                            }
                        </message>
                    </response>
        ...
        try {
            <response
                ...
                <message>removed {$file-name}
                    {xmldb:remove($collection, $file-name)}</message>
            </response>
        } catch * {
            <response
                status="fail">
                    ...
                    <xhtml>
                        <html>
                            ...
                            <body>
                                ...
                                <p><b>Please fix these issues as soon as possible and push the data to the <b>institutions</b> repo again.</b></p>
