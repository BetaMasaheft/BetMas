...
declare
%rest:GET
%rest:path("BetMasWeb/gender/rels")
%output:method("json")
                ...
                <div
                    ...
                    <div
                        ...
                        <p>At the moment the data contains some information 
                             about {count(config:distinct-values($sparql//sr:binding[@name eq "person"]))}, 
...
declare
%rest:GET
%rest:path("/BetMasWeb/gender/data")
...
declare
%rest:GET
%rest:path("/BetMasWeb/gender/table")
%output:method("html5")
function genderInfo:table() {
   ...
   transform:transform($sparql,
    'xmldb:exist:///db/apps/BetMasWeb/rdfxslt/sparqltable.xsl', ())    }
    </div></div>
      {nav:footerNew()}
                <script
                    type="text/javascript"
...
declare
%rest:GET
%rest:path("/BetMasWeb/gender/table/female")
%output:method("html5")
...
declare
%rest:GET
%rest:path("/BetMasWeb/gender/table/male")
%output:method("html5")
...
declare
%rest:GET
%rest:path("/BetMasWeb/gender/page")
%output:method("html5")
...
declare
%rest:GET
%rest:path("/BetMasWeb/gender/graph")
%output:method("html5")
