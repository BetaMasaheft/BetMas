...
declare variable $comparems:meta := (<meta  xmlns="http://www.w3.org/1999/xhtml" name="description" content="{$config:repo-descriptor/repo:description/text()}"/>,
...
%rest:GET
%rest:POST
%rest:path("/BetMasWeb/comparems")
%rest:query-param("mss", "{$mss}", "")
%output:method("html5")
function comparems:compareSelected(
$mss as xs:string*) {
let $list := $mss
let $fullurl := ('?mss=' || $mss)
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"/>
    ...
    <body id="body">
       {nav:barNew()}
        ...
        <form action="" class="w3-container" data-hint="enter here the id of the mss of a certain work you would like to compare.">
