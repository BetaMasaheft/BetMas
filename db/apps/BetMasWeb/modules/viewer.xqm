...
let $id := string($m/ancestor::t:TEI/@xml:id) return
            (:bodleian:)
           ...
           (:vatican:)
            ...
            :)
            else if(contains(viewer:facsSwitch($m), 'uni-hamburg')) 
           ...
           (:BNF:)
            else if (contains(viewer:facsSwitch($m), 'gallica')) 
