...
import module namespace switch2 = "https://www.betamasaheft.uni-hamburg.de/BetMas/switch2"  at "xmldb:exist:///db/apps/BetMasService/modules/switch2.xqm";
import module namespace kwic = "http://exist-db.org/xquery/kwic" at "resource:org/exist/xquery/lib/kwic.xql";
import module namespace templates="http://exist-db.org/xquery/templates" ;
import module namespace log="http://www.betamasaheft.eu/log" at "xmldb:exist:///db/apps/BetMasService/modules/log.xqm";
import module namespace coord="https://www.betamasaheft.uni-hamburg.de/BetMas/coord" at "xmldb:exist:///db/apps/BetMasService/modules/coordinates.xqm";
import module namespace nav="https://www.betamasaheft.uni-hamburg.de/BetMas/nav" at "xmldb:exist:///db/apps/BetMasService/modules/nav.xqm";
import module namespace ann = "https://www.betamasaheft.uni-hamburg.de/BetMas/ann" at "xmldb:exist:///db/apps/BetMasService/modules/annotations.xqm";
import module namespace all="https://www.betamasaheft.uni-hamburg.de/BetMas/all" at "xmldb:exist:///db/apps/BetMasService/modules/all.xqm";
import module namespace editors="https://www.betamasaheft.uni-hamburg.de/BetMas/editors" at "xmldb:exist:///db/apps/BetMasService/modules/editors.xqm";
...
import module namespace fusekisparql = 'https://www.betamasaheft.uni-hamburg.de/BetMas/sparqlfuseki' at "xmldb:exist:///db/apps/BetMasService/fuseki/fuseki.xqm";
import module namespace console="http://exist-db.org/xquery/console";
import module namespace apptable="https://www.betamasaheft.uni-hamburg.de/BetMas/apptable" at "xmldb:exist:///db/apps/BetMasService/modules/apptable.xqm";
import module namespace functx = "http://www.functx.com";

(:~declare variable $app:item-uri as xs:string := raequest:get-parameter('uri',());:)
declare variable $app:deleted := doc('/db/apps/BetMasService/lists/deleted.xml');
...
declare variable $app:languages := doc('/db/apps/BetMasService/lists/languages.xml');
declare variable $app:tax := doc('/db/apps/BetMasService/lists/canonicaltaxonomy.xml');
...
%templates:wrap
    ...
    $node as node(), 
    $model as map(*)) {
    transform:transform($model("sparqlResult"), 'xmldb:exist:///db/apps/BetMasService/rdfxslt/sparqltable.xsl', ())
