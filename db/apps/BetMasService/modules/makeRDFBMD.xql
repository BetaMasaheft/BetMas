...
(:imports the transformation to RDF and module to take that and push it to the Fuseki Triplestore -- version of makeRDF for transforming BetMasData:)
...
declare variable $local:data2rdf := 'xmldb:exist:///db/apps/BetMasService/rdfxslt/data2rdfBMD.xsl';
...
let $collection-uri := '/db/apps/BetMasData/' 
