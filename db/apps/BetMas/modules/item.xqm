...
(: @TODO: This module is also in betmasweb, but some pages uses thismodule instead. For example 'exist/apps/BetMasWeb/works/LIT1385Fekkar/main' runs this module :)
...
<a href="{$config:appUrl}/manuscripts/{string($wit/@corresp)}/main" target="_blank"><b class="lead">{string($wit/@xml:id)}</b>: {titles:printTitleID(string($wit/@corresp))}</a></li>}
{
...
Not sure how to do this? Have a look at the <a href="{$config:appUrl}/Guidelines">Beta maṣāḥǝft Guidelines</a>!
</span>
    </div>
<div class="w3-bar-item w3-tooltip" >
...
<div class="w3-bar-item w3-tooltip" >
           <a class="w3-button w3-padding-small w3-gray"  id="mainEntryLink" href="{$config:appUrl}/{$collection}/{$id}/main"
           target="_blank" >Entry</a>
<span class="w3-text w3-tag itemoptiontooltip">Main Entry</span>
 </div>
<div class="w3-bar-item w3-tooltip">
<a class="w3-button w3-padding-small w3-gray"  id="TEILink" href="{$config:appUrl}{( '/tei/' || $id ||  '.xml')}" target="_blank">TEI/XML</a>
...
<div class="w3-bar-item w3-tooltip">
<a class="w3-button w3-padding-small w3-gray"  id="GraphViewLink"  href="{$config:appUrl}/{$collection}/{$id}/graph" target="_blank">{if($collection = 'manuscripts') then <i>Syntaxe</i> else 'Graph'}</a>
<span class="w3-text w3-tag itemoptiontooltip">AAAAAAAAAAAAAAAAAAAAASee graphs of the information available. If the manuscript contains relevant information,
...
<div class="w3-bar-item w3-tooltip"
><a class="w3-button w3-padding-small w3-gray"  href="{$config:appUrl}/{$collection}/{$id}/analytic" target="_blank">Relations</a>
<span class="w3-text w3-tag itemoptiontooltip">Further visualization of relational information</span></div>
  ...
  >
    ...
    <div class="w3-bar-item w3-tooltip" >
    <a class="w3-button w3-padding-small w3-gray"  href="{$config:appUrl}{('/workmap?worksid=' || $id  )}" target="_blank">Manuscripts Map</a>
...
return
    ...
    <div xmlns="http://www.w3.org/1999/xhtml" class="w3-twothird">
            ...
            if($same) then
                    for $s in $same return <p>This record is the same as <a href="{$config:appUrl}{string($s/@passive)}" target="_blank">{titles:printTitleID($s/@passive)}</a>.</p>
            else ())}
...
return
            <a target="_blank"
            href="{$config:appUrl}/manuscripts/{$repo}/list"
            role="button"
...
(     <div>{for $t in $list return <a class="w3-tag w3-red" href="{$config:appUrl}/places/list?placetype={$t}" target="_blank">{$t}</a>}</div>,
 ...
 if($document//t:personGrp) then
                         <div  class="w3-row">   <span class="w3-tag w3-red">
                            ...
                            Group</span></div> else ()
 case 'work' return
  if ($document//t:titleStmt/t:author) then <div  class="w3-row"><p class="w3-large"><a href="{$config:appUrl}{$document//t:titleStmt/t:author[1]/@ref}">{$document//t:titleStmt/t:author[1]}</a></p></div> else ()
   default return ()
   }
...
declare function item2:AdminLocTable($adminLoc as element()*){
                                           ...
                                           <td>{
                                           if($s/@ref) then
                                           (<a target="_blank" href="{$config:appUrl}/{$s/@ref}">{titles:printTitleMainID($s/@ref)}</a>,
...
<div  class="mainrelations w3-container">
                                          ...
                                          {$name}
                                          </a> (<a href='{$config:appUrl}/authority-files/list?keyword={$s}'>See all items for this period</a>)</li>
                                          }</ul>
                                           }
                                           </div>
                                           else()
...
<div  class="mainrelations w3-container">
                    ...
                    return
                      ...
                      <ul  class="w3-ul w3-hoverable">{for $p in $par/@active
                        ...
                        <li class="nodot"><a href="{$config:appUrl}/{$p}"  class="MainTitle" data-value="{$p}">{$p}</a></li>
                        }</ul>)
...
declare function item2:RestMiniaturesKeys($id){
     ...
     return
                                           ...
                                           <li class="nodot"><a target="_blank" role="button" class="btn btn-success btn-sm" href="{$config:appUrl}/authority-files/list?keyword={$K}">{titles:printTitleMainID($K)}</a>
                                               in
                                               <ul>
                                               {for $th in $t
                                               ...
                                               return
                                               <li><a target="_blank" href="{$config:appUrl}/{$containerID}">{titles:printTitleMainID($containerID)}</a></li>
                                               }</ul>
...
<p><a target="_blank" href="{$config:appUrl}/manuscripts/list?contents={$id}">See these {$countDistMss} manuscripts in the list view.</a> Scrolling in this box will also show you a summary of all the occurences.</p>
...
(:                                                         order by root($hit)/t:TEI/@xml:id:)
                 ...
                 <a class="w3-bar-item w3-circle" target="_blank" href="{$config:appUrl}/manuscripts/{$itemid}/viewer">{
...
<li>addition with id <b>{string($item/@xml:id)}</b> {if($h/text()) then (', ', <i>{$h/text()}</i> ) else () } {$placement} {$position}</li>
                                             ...
                                             return
  (<p>As additional content associated with the keyword <b><a href="{$config:appUrl}/authority-files/list?keyword={string($broad)}">{titles:printTitleMainID($broad)}</a></b> this unit
...
<p>
<a target="_blank" href="{$config:appUrl}/{$c}">{$tit}</a> is listed as {$c} in the following {count($countwitnesses)} manuscripts {count($witnesses)} times:</p>,
...
return <p>Click the following link to compare a <a target="_blank" href="{$config:appUrl}/compareSelected?mss={$stringsubids},{$id}">list of manuscripts linked to both {$stringsubids} and {$c}.</a></p> else ()}
</div>
) else <p>
