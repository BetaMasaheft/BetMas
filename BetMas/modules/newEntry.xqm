...
<div class="col-md-10"><div class="container" id="formKeywords">
                {
               ...
               default return doc($config:data-rootA || '/taxonomy.xml')//t:taxonomy//t:catDesc/text()
                ...
                <input type="checkbox" value="{$k}" name="keywords"/>{titles:printTitleMainID($k, $config:data-rootA)}</label>
                }
...
<div class="col-md-10"><textarea  class="form-control"  id="note" name="note"></textarea>
...
<div class="col-md-10">
<select  class="form-control"  id="relations" name="relations" multiple="multiple" style="height:400px">
...
<select class="form-control"  id="gotohits"  name="attested" >
