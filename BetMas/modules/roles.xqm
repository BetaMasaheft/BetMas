...
<p>There are in total {count($roleAttestationsIdentified)} attestations of the role name <span class="w3-tag w3-gray">{$r}</span> related to {count(distinct-values($roleAttestations/parent::t:persName/@ref))} persons.</p>
