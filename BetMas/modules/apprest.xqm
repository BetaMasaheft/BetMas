...
(:        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/alpheios-embedded/dist/style/style.min.css"/>,
        ...
        <script type="text/javascript" src="https://code.jquery.com/ui/1.12.1/jquery-ui.min.js"  async="async"></script>,
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/virtual-keyboard/1.26.22/js/jquery.keyboard.js"  async="async"/>,
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/virtual-keyboard/1.26.22/js/jquery.mousewheel.min.js"  async="async"/>,
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/virtual-keyboard/1.26.22/js/jquery.keyboard.extension-typing.min.js"  async="async"/>,
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/virtual-keyboard/1.26.22/js/jquery.keyboard.extension-altkeyspopup.min.js"  async="async"></script>,
        <script type="text/javascript" src="http://cdn.jsdelivr.net/jquery.slick/1.6.0/slick.min.js"  async="async"/>,
        <script type="text/javascript" src="$shared/resources/scripts/loadsource.js"  async="async"/>,
        <script type="text/javascript" src="$shared/resources/scripts/bootstrap-3.0.3.min.js"  async="async"/>,
        <script  type="text/javascript" src="resources/js/jquery.dataTables.min.js"  async="async"/>,
        <script type="text/javascript" src="resources/js/dataTables.bootstrap.min.js"  async="async"/>,
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-slider/9.5.1/bootstrap-slider.min.js"  async="async"/>,
        <script type="text/javascript" src="resources/js/diacriticskeyboard.js"  async="async"/>,
        <script type="text/javascript" src="resources/openseadragon/openseadragon.min.js"  async="async"/>,
        <script type="text/javascript" src="resources/js/analytics.js"  async="async"></script>,
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/intro.js/2.9.3/intro.js"  async="async"></script>,
        <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js" async="async"></script> (: ,
...
<link xmlns="http://www.w3.org/1999/xhtml" rel="stylesheet" type="text/css" href="resources/css/mapbox.css"/>,
       ...
       <script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript" src="http://cdn.leafletjs.com/leaflet/v0.7.7/leaflet.js"  async="async"/>,
        <script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript" src="resources/js/mapbox.js"  async="async"/>,
        <script  xmlns="http://www.w3.org/1999/xhtml" type="text/javascript" src="resources/js/Leaflet.fullscreen.min.js"  async="async"/>,
       <script type="text/javascript" src="resources/js/leaflet-ajax-gh-pages/dist/leaflet.ajax.min.js"  async="async"></script>,
                         <script xmlns="http://www.w3.org/1999/xhtml" type="text/javascript"  src="https://cdnjs.cloudflare.com/ajax/libs/vis/4.12.0/vis.min.js"  async="async"/>(:,
