        ...
        <html version="XHTML+RDFa 1.1">
            ...
            <body>
                <div class="w3-panel w3-card-4 w3-red w3-center">
                    ...
                    <p>It shows only limited details with the only purpose of facilitating the
                        editorial process before submitting a formal Pull Request.</p>
                    <p>Only the functionalities of XSLT, CSS and JQUERY are provided. No Links will
                        work. No button with request functions.</p>
                    <p>References to files which are not yet approved will also not show anything.</p>
                </div>
                <div class="w3-container">
                <div id="MainData" class="w3-half">
                    <div id="description">
          ...
          <xsl:variable name="startsection">1</xsl:variable>
                <xsl:variable name="perpage" select="count(//t:div[@type = 'edition']/t:div[@type='textpart'])"/>
                <div class="w3-half">
