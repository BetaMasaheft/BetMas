                    ...
                    <li class="dropdown" id="about">
                      ...
                      <span>  Hi {xmldb:get-current-user()}!</span>
                        ...
                        <ul class="dropdown-menu  list-group">
                            ...
                            <li class="list-group-item">
                                <a href="/authority-files/list">Authority files</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown" id="warnings">
                     <p class="navbar-btn">
                       <a role="button" class="btn btn-danger" data-toggle="modal" data-target="#versionInfo">ACHTUNG!</a>
                            <a role="button" class="btn btn-warning"  target="_blank" href="https://github.com/SChAth/ScAthiop/issues/new?labels=app&amp;assignee=PietroLiuzzo&amp;body=There%20is%20an%20issue%20with%20a%20list%20view">new issue</a>
               </p>
               </li>
                ...
                <form action="/search.html" class="navbar-form" role="search">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            ...
                            <a href="/as.html" title="advanced search" class="btn btn-default">
