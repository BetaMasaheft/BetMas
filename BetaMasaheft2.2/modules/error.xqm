...
<div xmlns="http://www.w3.org/1999/xhtml" class="container alert alert-warning">
    ...
    case 'repo' return (<h1>{$name('name')} is not the id af any available repository.</h1>,<p class="lead">Available repositories are listed <a href="/institutions/list">here</a>.</p>
    )
