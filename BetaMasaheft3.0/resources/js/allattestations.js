...
$('#showattestations').on('click', function () {
   ...
   var report = 'There are <span class="badge badge-primary">' + data.results.length + '</span> attestations.'
...
function occurrences(occ) {
    ...
    var alloccs = '<div class="row cooccurences">In the same contex of this attestation also the following ' + type + ' occurr <table class="table table-responsive"><thead><tr><th>name</th><th>type</th></tr></thead><tbody>' + allnames + '</tbody></table></div>'
    return alloccs
};
