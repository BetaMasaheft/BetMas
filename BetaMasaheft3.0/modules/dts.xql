...
(:~ main access point to API documentation for DTS :)
declare
%rest:GET
%rest:path("/BetMas/api/dts/text")
%output:method("json")
function dts:dtsTexts() {
  ( $config:response200Json,
         <json:value>
         <documentation>http://betamasaheft.eu/api/</documentation>
         </json:value>)
...
(:~ main access point to DTS style API returning citations from text :)
declare
%rest:GET
...
(:~ dts/collection http://distributed-text-services.github.io/collection-api/#/:)
declare
%rest:GET
...
function dts:Collection($start as xs:integer*) {
    ...
    return
       ($config:response200Json,
 log:add-log-message('/api/dts/collections', xmldb:get-current-user(), 'dts'),
    <json:value>
        {
        <context>
