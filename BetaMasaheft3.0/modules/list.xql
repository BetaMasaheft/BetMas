...
let $parameters := map{'key':=$keyword,'lang':=$language,'date':=$date-range,'clavisID':=$clavisID,'clavistype':=$clavistype,'cp':=$cp,'numberOfParts':=$numberOfParts}
return
...
<link xmlns="http://www.w3.org/1999/xhtml" rel="stylesheet" type="text/css" href="resources/css/mapbox.css"/>
    ...
    <body id="body">
       ...
       <div class="col-md-12"><div id="entitymap" style="width: 100%; height: 400px; margin-top:100px" />
