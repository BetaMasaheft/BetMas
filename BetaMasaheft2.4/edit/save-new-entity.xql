...
let $data-collection := '/db/apps/BetMas/data/' || $collection || '/new'
...
if ($collection = 'manuscripts' or $collection = 'authority-files') then
    ...
    let $ids := for $x in collection(concat($config:data-root, '/', $collection))//t:TEI/@xml:id
    return
                ...
                <body>
                    {
                        ...
                        then
                            <listPlace>{
                                ...
                                {if(exists($relations)) then <listRelation>
                                {
                                            for $r in $relations
                                            return
                                                element relation {
                            ...
                            then
                                ...
                                <div
                                    type="bibliography">
                                    {if(exists($relations)  and $attested != '') then <listBibl
                                        type="relations">
                                        <bibl/>
                                        {(if ($attested = '') then
                                                ()
                                    ...
                                    </listBibl> else if(exists($relations)) then (
                                    <listBibl
                                        type="relations">
                                        <bibl/>
                                        {if ($relations = '') then
