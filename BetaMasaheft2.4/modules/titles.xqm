...
declare
%test:arg('pRef', 'gn:12355') %test:assertEqual('')
%test:arg('pRef', 'pleiades:123456') %test:assertEqual('')
%test:arg('pRef', 'Q123456') %test:assertEqual('')
%test:arg('pRef', 'LOC1234ABC') %test:assertEqual('')
function titles:decidePlaceNameSource($pRef as xs:string) as xs:string{
