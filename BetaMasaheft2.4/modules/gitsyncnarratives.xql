...
declare function local:do-update($commits as node()*, $contents-url as xs:string?) {
    ...
    return
        ...
        let $collection := xs:anyURI('/db/apps/BetMas/data/narratives')
                    ...
                    <xhtml>
                        <html>
                            ...
                            <body>
                                ...
                                <p><b>Please fix these issues as soon as possible and push the data to the <b>narratives</b> repo again.</b></p>
